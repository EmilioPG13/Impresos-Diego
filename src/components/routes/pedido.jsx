                ...
                <form className="m-12">
                    <div className="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div className="max-w-full">
                            ...
                            <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                ...
                                <option value="US">Libros/Revistas Hot-melt</option>
                                <option value="CA">Revistas a Grapa</option>
                                <option value="FR">Trípticos</option>
                                <option value="DE">Polípticos</option>
                                <option value="DE">Manteletas</option>
                            </select>
                        </div>
                        <div className="max-w-full">
                    ...
                    <div className="mb-6">
                        ...
                        <input type="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="john.doe@company.com" required />
                                            ...
                                            <div className="w-full mb-4 border border-gray-300 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500">
