        ...
        <>
            <div className="m-12">
                <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                    Cotiza Tu proyecto de impresion
                </h1>
                <p className="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                    Si estás buscando imprimir revistas o catálogos para tu negocio, institución o proyecto, estás en el lugar correcto. Solo deja tus datos aquí y te enviaremos un presupuesto en 72 horas. <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Ten en cuenta que solo nos encargamos de la impresión, no del diseño.</span>
                </p>
                <br/>
                <p className="text-sm font-normal text-gray-500 lg:text-xl dark:text-gray-400">
                    Ingresa tu informacion y nosotros nos pondremos en contacto contigo en menos de 24 horas.
                </p>
            </div>
