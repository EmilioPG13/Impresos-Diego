...
const MobileMenu = ({ isOpen, onClose, handleLinkClick }) => {
    ...
    return createPortal(
        <div className={`lg:hidden ${isOpen ? 'pointer-events-auto' : 'pointer-events-none'}`} role="dialog" aria-modal="true">
            {/* Background backdrop with fade transition */}
            <div
                className={`
                    fixed inset-0 z-[9998] bg-gray-900/80 backdrop-blur-sm
            ...
            <div
                className={`
                    fixed inset-y-0 left-0 z-[9999] w-full overflow-y-auto bg-white px-6 py-6 
            ...
            >
                ...
                <div className="flex items-center justify-between">
                    <Link
                        to="/"
                        onClick={() => { handleLinkClick('Inicio'); onClose(); }}
                        className="-m-1.5 p-1.5"
                    >
                        <span className="sr-only">Impresos Diego</span>
                ...
                <div className="mt-6 flow-root">
                    <div className="-my-6 divide-y divide-gray-500/10">
                        ...
                        <div className="py-6">
                            <a
                                href="tel:2222488993"
                                className="-mx-3 flex items-center gap-3 rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 transition-colors duration-200"
                            >
                        ...
                        {/* Social Links */}
                        <div className="py-6">
                            <p className="text-sm font-medium text-gray-500 mb-4">Síguenos</p>
